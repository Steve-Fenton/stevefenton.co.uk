...
bannerImage:
    src: /img/2015/07/stupidpie.png
    alt: An orange pie chart with gradient colours and circular segments that are not quite thirds.
authors:
    - steve-fenton
categories:
    - 'Pie Charts'
...
:::figure{.inset}
:img{src="/img/2015/07/stupidpie.png" alt="Stupid Pie Chart: An orange pie chart with gradient colours and circular segments that are not quite thirds." loading="lazy"}
