...
tags:
    ...
    - SQL
    - 'Virtual Machine'
description: Reducing Azure VM disk size isn't supported in the portal. Learn how to replace large disks with smaller ones by creating new disks and copying data manually.
---
