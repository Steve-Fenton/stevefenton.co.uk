---
title: Westrum's organizational cultures are vital but misunderstood
subtitle: "There's a robust way to test culture by focusing on information flow"
pubDate: 2026-09-07
description: Find out why Westrum's typology is a reliable way to assess culture and why the names sometimes cause confusion.
keywords: "culture,westrum,typology"
navMenu: false
bannerImage:
...
meta:
    - name: canonical
      content: https://thenewstack.io/westrums-organizational-cultures-are-vital-but-misunderstood/
---

In 1988, sociologist Ron Westrum created a typology of organizational culture and published his findings in a [2004 health industry paper](https://qualitysafety.bmj.com/content/qhc/13/suppl_2/ii22.full.pdf). Westrum's classification system has become one of the best ways to understand and predict an organization's performance. The research into generative organization culture has become part of the [DevOps Research and Assessment (DORA) Core](https://dora.dev/core/) collection, a set of capabilities, metrics and outcomes proven to endure through multiple years of study.
...
Westrum took a different approach. He wanted to understand how culture affected safety, not employee satisfaction or retention. To measure this, he was interested in the characteristics of information flow. Would better behaviour around information result in a safer organization?
...
A generative culture is high trust and low blame. The [Accelerate State of DevOps Report](https://cloud.google.com/devops/state-of-devops) has found that generative culture predicts better software delivery performance and increased job satisfaction. Crucially, it also predicts better goal attainment at the organizational level. Simply put, a healthy culture is a profitable culture.

## Are cultures mislabelled?
...
## Building a healthy organization by embracing a generative model
