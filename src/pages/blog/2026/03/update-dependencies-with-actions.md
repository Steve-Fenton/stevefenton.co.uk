...
:::figure
:img{src="/img/2026/03/update-deps-pr.png" alt="A pull request containing dependency updates" loading="lazy"}
::figcaption[A pull request containing dependency updates]
:::
