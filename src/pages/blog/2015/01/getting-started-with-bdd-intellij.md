---
title: 'Getting started with BDD with IntelliJ'
navMenu: false
pubDate: 2015-01-17T16:33:28+00:00
bannerImage:
    src: /img/2015/07/intellij-new-project.jpg
    alt: New IntelliJ Project
authors:
    - steve-fenton
categories:
    - Automation
...
Here is a quick step-by-step example of how to get started with BDD in IntelliJ. You can also follow these examples if you are using other IDEs, but some of the automatic good stuff may not happen (like auto-downloading plugins to help you edit the feature files and prompting you to import new Maven dependencies).
