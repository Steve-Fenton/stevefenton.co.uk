...
bannerImage:
    src: /img/2015/07/image.jpg
    alt: Photo by Steve Fenton. A key has been left in the lock of a stainless steel case.
authors:
    - steve-fenton
categories:
    - Process
...
:::figure{.inset}
:img{src="/img/2015/07/image.jpg" alt="Photo by Steve Fenton. A key has been left in the lock of a stainless steel case."}
:::
