...
bannerImage:
    src: /img/2015/07/diagnostic-tools.png
    alt: Diagnostic tools showing the memory and CPU profile of an application being debugged.
authors:
    - steve-fenton
categories:
    - 'Visual Studio'
...
:::figure
:img{src="/img/2015/07/diagnostic-tools.png" alt="Diagnostic tools showing the memory and CPU profile of an application being debugged."}
:::
