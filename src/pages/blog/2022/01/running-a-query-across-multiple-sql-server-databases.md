...
[![The temp mq folder with an input and output file](/img/2022/01/temp-mq-folder.jpg)](/2022/01/running-a-query-across-multiple-sql-server-databases/temp-mq-folder/)
