...
bannerImage:
    src: /img/2015/07/jmeter-param-controller.png
    alt: JMeter's parameterized controller interface.
authors:
    - steve-fenton
categories:
    - Automation
...
In the above example, the module controller calls the reusable simple controller. The variables used in the parameterized controller will be used by the reusable simple controller. Each parameterized controller you use can have a different value for the "Name" variable.
