...
bannerImage:
    src: /img/2015/07/estimate-guess.png
    alt: A guess is a subclass of the things we call estimates.
authors:
    - steve-fenton
categories:
    - Process
...
:::figure
:img{src="/img/2015/07/estimate-guess.png" alt="Estimates vs Guess Diagram: A guess is a subclass of the things we call estimates." loading="lazy"}
:::
