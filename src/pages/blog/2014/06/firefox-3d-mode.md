...
bannerImage:
    src: /img/2015/07/firefox-3d-view.jpg
    alt: Firefox displaying a web page in 3D so the nesting of elements is highlighted as stacks.
authors:
    - steve-fenton
categories:
    - Browsers
...
:::figure
:img{src="/img/2015/07/firefox-3d-view.jpg" alt="Firefox 3D View: Firefox displaying a web page in 3D so the nesting of elements is highlighted as stacks."}
:::
