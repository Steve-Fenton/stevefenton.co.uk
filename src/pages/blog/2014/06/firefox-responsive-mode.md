...
bannerImage:
    src: /img/2015/07/firefox-responsive-mode-screenshot.jpg
    alt: Firefox set to responsive mode to test a webpage.
authors:
    - steve-fenton
categories:
    - Browsers
...
:::figure
:img{src="/img/2015/07/firefox-responsive-mode-screenshot.jpg" alt="Firefox set to responsive mode to test a webpage."}
:::
