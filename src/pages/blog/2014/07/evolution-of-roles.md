...
bannerImage:
    src: /img/2021/07/roles.png
    alt: Over time, each new software method has had fewer roles.
authors:
    - steve-fenton
categories:
    - Process
...
:::figure
:img{src="/img/2021/07/roles.png" alt="Role Comparison: Over time, each new software method has had fewer roles."}
:::
