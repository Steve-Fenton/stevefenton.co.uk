...
bannerImage:
    src: /img/2015/07/php-version-adoption-pie1.png
    alt: 
authors:
    - steve-fenton
categories:
...
Despite the pie chart not following any of the [best practices for pie charts](/blog/2011/10/a-great-example-of-a-terrible-pie-chart/), you can tell that the purple section is the biggest. You can then look up that this is version 5.3.
