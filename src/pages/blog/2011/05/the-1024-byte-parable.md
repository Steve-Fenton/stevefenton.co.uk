...
bannerImage:
    src: /img/2011/05/byte-counter.png
    alt: A UTF-8 string length and byte counter validating the parable.
authors:
    - steve-fenton
categories:
    - Programming
...
And just for the purposes of double checking, if you do paste this into a [byte counter](https://mothereff.in/byte-counter), watch out for any of the simple quotes and dashes being converted into curly special versions as you'll end up with more bytes that way.

:::figure
:img{src="/img/2011/05/byte-counter.png" alt="A UTF-8 string length and byte counter validating the parable." loading="lazy"}
