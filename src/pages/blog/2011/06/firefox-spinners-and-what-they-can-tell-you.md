...
bannerImage:
    src: /img/2015/07/firefoxloading.jpg
    alt: A sticky note showing anti-clockwise (waiting for first byte) vs clockwise (receiving data) spinners.
authors:
    - steve-fenton
categories:
    - Browsers
...
:::figure
:img{src="/img/2011/06/firefox-quantum-grey-cylon.png" alt="Firefox Quantum Grey Cylon"}
<figcaption>Grey Cylon (equivalent to the old anti-clockwise grey spinner)… waiting for response</figcaption>
:::

:::figure
:img{src="/img/2011/06/firefox-quantum-blue-cylon.png" alt="Firefox Quantum Blue Cylon"}
<figcaption>Blue Cylon (equivalent to the old clockwise green spinner)… receiving the response</figcaption>
:::
...
:::figure
:img{src="/img/2015/07/firefoxloading.jpg" alt="A sticky note showing anti-clockwise (waiting for first byte) vs clockwise (receiving data) spinners." loading="lazy"}
