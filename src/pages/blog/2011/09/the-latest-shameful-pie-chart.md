...
bannerImage:
    src: /img/2015/07/insidious_pie_chart.jpg
    alt: A pie chart crammed with so many segments the labels are a tangled mess of lines and numbers.
authors:
    - steve-fenton
categories:
    - 'Pie Charts'
...
:::figure
:img{src="/img/2015/07/insidious_pie_chart.jpg" alt="Insidious Pie Chart: A pie chart crammed with so many segments the labels are a tangled mess of lines and numbers." loading="lazy"}
