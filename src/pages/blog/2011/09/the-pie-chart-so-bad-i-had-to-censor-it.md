...
bannerImage:
    src: /img/2015/07/piechartdisgust.png
    alt: An exploded pie chart with labels that overlap each other, making it impossible to read the values.
authors:
    - steve-fenton
categories:
    - 'Pie Charts'
...
:::figure
:img{src="/img/2015/07/piechartdisgust.png" alt="Censored Pie Chart: An exploded pie chart with labels that overlap each other, making it impossible to read the values." loading="lazy"}
