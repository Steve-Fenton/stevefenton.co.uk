...
bannerImage:
    src: /img/2017/10/Duck_of_Vaucanson.jpg
    alt: Duck of Vaucanson
authors:
    - steve-fenton
categories:
    - Programming
...
Duck of Vaucanson by Unknown, Public Domain, [Wikimedia](https://commons.wikimedia.org/w/index.php?curid=1493624)
...
In general `eval` is *A Bad Thing*&trade;, but actually the feature itself isn't evil – it is simply a signpost for a design error.
