...
bannerImage:
    src: /img/2017/10/azure-app-service-diagnostic-tools.jpg
    alt: Azure App Service Diagnostic Tools
authors:
    - steve-fenton
categories:
    - Programming
