...
bannerImage:
    src: /img/2017/03/stack-ranking-vs-prioritisation.jpg
    alt: Stack Ranking vs Prioritisation
authors:
    - steve-fenton
categories:
    - Process
...
Why is it that modern software development processes prefer stack ranking over prioritisation? There is a simple answer - and isn't (just) the simplistic "everything will be raised as a Priority 1" that you usually hear.
