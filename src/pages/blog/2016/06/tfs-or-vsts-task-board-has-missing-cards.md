...
bannerImage:
    src: /img/2016/06/parent-child-cards-before.png
    alt: Parent and Child Cards Before Linking
authors:
    - steve-fenton
categories:
    - 'Azure DevOps'
...
This started to affect our trust in the tools and we raised a big frown via the feedback form on Azure DevOps.
