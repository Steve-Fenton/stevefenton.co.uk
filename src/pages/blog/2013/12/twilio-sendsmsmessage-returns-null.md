...
pubDate: 2013-12-09
bannerImage:
    src: /img/2015/07/twilio.jpg
    alt: A hello world text message sent using Twilio.
authors:
    - steve-fenton
categories:
    - Programming
...
:::figure{.inset}
:img{src="/img/2015/07/twilio.jpg" alt="A hello world text message sent using Twilio."}
:::
