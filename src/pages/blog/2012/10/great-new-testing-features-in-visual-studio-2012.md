...
bannerImage:
    src: /img/2015/07/vs2012-code-coverage.png
    alt: Covered lines of code are highlighted with a background colour in the code editor.
authors:
    - steve-fenton
categories:
    - 'Visual Studio'
