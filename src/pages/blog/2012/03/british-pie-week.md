...
bannerImage:
    src: /img/2015/07/android_distribution_pie_chart1.png
    alt: Android Distribution Pie Chart has too many segments to be helpful.
authors:
    - steve-fenton
categories:
    - 'Pie Charts'
...
:::figure
:img{src="/img/2015/07/android_distribution_pie_chart1.png" alt="Android Distribution Pie Chart has too many segments to be helpful." loading="lazy"}
:::
