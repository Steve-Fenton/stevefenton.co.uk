...
Is this the intention of Scrum's authors? Absolutely not. But like [Benington and Royce](https://octopus.com/devops/history/early-software-delivery-models/), they're faced with rather nasty-looking interpretations of their work that don't resemble its intention. Remember when Benington said that the _top-down programming_ approach where specifications had to be completed before code started was a _misleading and dangerous_ interpretation of the Lincoln Labs model? Well, so it goes for every author of such a process, sadly.
